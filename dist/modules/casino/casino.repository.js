...
let CasinoRepository = class CasinoRepository {
    ...
    async getCasinoDetails(casinoId) {
        ...
        return this.database.query((request) => request.input('CasinoId', sql.Char(16), casinoId), `
    ...
    async getLCEnabledTables(casinoId) {
        const schema = this.database.schema;
        return this.database.query((request) => request.input('Casino_id', sql.Char(16), casinoId), `
